...
- <a name="xml"></a>**XML *(eXtensible Markup Language)* **  *(eXtensible Markup Language)* es un meta-lenguaje que permite definir lenguajes de marcas desarrollado por el World Wide Web Consortium (W3C) 0 para almacenar datos en forma legible.
